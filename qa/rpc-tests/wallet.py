...
#   c) node1 mines 32 blocks, so now node 0 has 60001slack, node 1 has 4250slack, node2 has none.
#   d) node0 sends 601 slack to node2, in two transactions (301 slack, then 300 slack).
