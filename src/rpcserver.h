...
/**
 * Econocalypse RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzslackseed(const UniValue& params, bool fHelp);
extern UniValue getzslackseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzslack(const UniValue& params, bool fHelp);
extern UniValue dzslackstate(const UniValue& params, bool fHelp);
