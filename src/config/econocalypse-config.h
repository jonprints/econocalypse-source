/* src/config/econocalypse-config.h.  Generated from econocalypse-config.h.in by configure.  */
/* src/config/econocalypse-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SLACK_CONFIG_H

#define SLACK_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.econocalypse.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Econocalypse Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Econocalypse Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "econocalypse"
