...
#ifndef Econocalypse_ZSLACKWALLET_H
#define Econocalypse_ZSLACKWALLET_H
...
public:
    CzSLACKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSLACK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSLACK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Econocalypse_ZSLACKWALLET_H
