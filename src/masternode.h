...
#define MASTERNODE_MIN_CONFIRMATIONS 300
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 SLACK, signature to prove
