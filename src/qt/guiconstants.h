...
/* Econocalypse GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Econocalypse"
#define QAPP_ORG_DOMAIN "econocalypse.org"
#define QAPP_APP_NAME_DEFAULT "Econocalypse-Qt"
#define QAPP_APP_NAME_TESTNET "Econocalypse-Qt-testnet"
