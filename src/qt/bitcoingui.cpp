...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Econocalypse address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and econocalypse: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSLACK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Econocalypse Core"), this);
    aboutAction->setStatusTip(tr("Show information about Econocalypse Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Econocalypse"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Econocalypse addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Econocalypse addresses"));
    ...
    openAction->setStatusTip(tr("Open a Econocalypse: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Econocalypse Core help message to get a list with possible Econocalypse command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Econocalypse Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Econocalypse network", "", count));
}
...
{
    QString strTitle = tr("Econocalypse Core"); // default title
