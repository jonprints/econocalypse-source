...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Econocalypse Core"),
     ...
     * override -datadir in the econocalypse.conf file in the default data directory
     * (to be consistent with econocalypsed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
