...
/** Utility functions used by the Econocalypse Qt UI.
 */
namespace GUIUtil
{
...
// Render Econocalypse addresses in monospace font
...
// Parse "econocalypse:" URI into recipient object, return true on successful parsing
