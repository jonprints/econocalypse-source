                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSLACKPathCustom = GetArg("-zslackbackuppath", "");
    ...
    if(!strzSLACKPathCustom.empty()) {
        ui->wallet_customzslackbackuppath->setText(QString::fromStdString(strzSLACKPathCustom));
        ui->wallet_customzslackbackuppath_label->setVisible(true);
        ui->wallet_customzslackbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSLACKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Econocalypse RPC console.") + "<br>" +
