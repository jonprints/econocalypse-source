...
#ifndef Econocalypse_ZSLACKTRACKER_H
#define Econocalypse_ZSLACKTRACKER_H
...
public:
    CzSLACKTracker(std::string strWalletFile);
    ~CzSLACKTracker();
...
#endif //Econocalypse_ZSLACKTRACKER_H
