...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Econocalypse Core econocalypse-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  econocalypse-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded econocalypse transaction") + "\n" +
                               "  econocalypse-tx [options] -create [commands]   " + _("Create hex-encoded econocalypse transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded econocalypse transaction
