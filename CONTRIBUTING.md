Contributing to Econocalypse Core
============================

The Econocalypse Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Econocalypse Core project, and is not to be
confused with overall Econocalypse Network Protocol consensus changes.

Whether a pull request is merged into Econocalypse Core rests with the project merge
...
Patches that change Econocalypse consensus rules are considerably more involved than
...
Where a patch set proposes to change the Econocalypse consensus, it must have been
...
The project leader is the release manager for each Econocalypse Core release.
