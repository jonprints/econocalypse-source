...
This mechanism has been integrated into Bitcore-Node-Econocalypse which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Econocalypse-Project/insight-api-econocalypse#web-socket-api](https://github.com/Econocalypse-Project/insight-api-econocalypse#web-socket-api) 
* API: [https://github.com/Econocalypse-Project/insight-api-econocalypse#swifttx-transactions](https://github.com/Econocalypse-Project/insight-api-econocalypse#swifttx-transactions) 
...
By default, the Econocalypse Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Econocalypse Core daemon:
