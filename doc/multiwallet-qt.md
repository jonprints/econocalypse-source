...
In order to support loading of multiple wallets in econocalypse-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is econocalypse.cpp.
...
Changes to econocalypse.cpp
----------------------
econocalypse.cpp is the entry point into econocalypse-qt, and as such, will require some minor modifications to provide hooks for
